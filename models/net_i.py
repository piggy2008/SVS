...
class INet(nn.Module):
    def __init__(self, cfg, GNN=False):
        ...
        self.se_many2 = SEMany2Many(8, 64)
    ...
    def forward(self, x, flow=None, shape=None):
        ...
        if flow is not None:
            ...
            feat_list2 = [out2h, out3h, out4h, out5v, out2f, out3f, out4f]
            out2h, out3h, out4h, out5v, out2f, out3f, out4f = self.se_many2(feat_list2, pred2)
