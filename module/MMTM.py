...
class SEQuart(nn.Module):
    ...
    def forward(self, low, high, flow, feedback):
        ...
        weighted_feat_a = excitation1 * low + excitation2 * high + excitation3 * flow + excitation4 * feedback
        ...
        feat_cat = torch.cat([weighted_feat_a, weighted_feat_a, weighted_feat_a, weighted_feat_a], dim=1)
