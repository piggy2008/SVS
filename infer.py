...
exp_name = 'VideoSaliency_2021-03-01 22:16:11'

args = {
    'gnn': True,
<<<<<<< HEAD
    'snapshot': '68000',  # your snapshot filename (exclude extension name)
=======
    'snapshot': '48000',  # your snapshot filename (exclude extension name)
>>>>>>> 242becf33264e6a45c564097e3ae3ceb6caed5be
        ...
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                if video != img_name.split('/')[0]:
                    ...
                    prediction2, prediction, prediction3, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = net(img_var, flow_var)
