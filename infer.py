...
exp_name = 'VideoSaliency_2021-01-13 14:45:27'

args = {
    'gnn': True,
    'snapshot': '28000',  # your snapshot filename (exclude extension name)
        ...
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                if video != img_name.split('/')[0]:
                    ...
                    prediction2, _, _, _, _, _, _, _, _, _, _, _, _, _, _ = net(img_var, flow_var)
                    prediction =  torch.sigmoid(prediction2)
